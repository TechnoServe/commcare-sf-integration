...
def process_participant_check_training_observation(data: dict, sf_connection):
    if data.get("app_id", "") == '30cee26f064e403388e334ae7b0c403b':  # Testing for ONLY KENYA
...
def process_participant_check_farm_visit_aa(data: dict, sf_connection):
    ...
    request_id = data.get("id")
    if survey_detail == 'Farm Visit - AA' and data.get("app_id", "") == '30cee26f064e403388e334ae7b0c403b': # Testing for ONLY KENYA
